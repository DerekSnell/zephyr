...
more details.  On this page, change the pull-down menu for "Choose your board
to start" to FRDM-K64F, and review the section "To update your board with 
OpenSDA applications".  Note that Segger does provide an OpenSDA J-Link Board-
...
instructions in :ref:`opensda-jlink-onboard-debug-probe` to program to the board. 
...
.. _OpenSDA Serial and Debug Adapter:
   https://www.nxp.com/design/software/development-software/sensor-toolbox-sensor-development-ecosystem/opensda-serial-and-debug-adapter:OPENSDA#FRDM-K64F
